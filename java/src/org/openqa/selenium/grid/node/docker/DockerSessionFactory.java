...
public class DockerSessionFactory implements SessionFactory {
  ...
  private final Duration serverStartTime;
  ...
  public DockerSessionFactory(
    ...
    this.serverStartTime = Require.nonNull("Server start time", serverStartTime);
  ...
  public Either<WebDriverException, ActiveSession> apply(CreateSessionRequest sessionRequest) {
    ...
    try (Span span = tracer.getCurrentContext().createSpan("docker_session_factory.apply")) {
      ...
      try {
        waitForServerToStart(client, serverStartTime);
  ...
  private Container startVideoContainer(
    ...
    try {
      ...
      waitForServerToStart(videoClient, serverStartTime);
    } catch (Exception e) {
